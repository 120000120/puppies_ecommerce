        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-5xl font-bold text-yellow-400 mb-6 animate-fade-in">Contáctanos</h2>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-yellow-500/20 hover:border-yellow-500/40 transition-all duration-300">
                <div className="space-y-8">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-2xl font-bold text-white mb-2">Horario de atención</h3>
              ...
              <div className="bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-yellow-500/20 hover:border-yellow-500/40 transition-all duration-300">
                ...
                <h3 className="text-3xl font-bold text-white mb-6 text-center">¿Listo para conocer a tu nuevo mejor amigo?</h3>
