    ...
    <section className="py-16 bg-gradient-to-r from-yellow-500 to-yellow-600 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link 
            to="/catalogo" 
            className="inline-flex items-center bg-black hover:bg-gray-900 text-white font-bold py-4 px-8 rounded-lg shadow-lg transition-all transform hover:scale-105"
          >
            Ver Catálogo
